...
* By comparing these three models, we can find that the logistic regression have both highest lower bound and highest upper bound of the confidence interval.So, we can conclude that the logistic regression has performed the best.
