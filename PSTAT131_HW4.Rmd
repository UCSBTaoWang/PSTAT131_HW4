...
* Answer:
Since we have 3 different types of models for all 10 folds, then we will fit 30 models in total to the data.
...
# on the testing data!
log_fit_test<- fit(lm_fit, titanic_test)
log_acc <- predict(log_fit_test, new_data = titanic_test, type = "class") %>% 
...
```
* My model’s testing accuracy is 0.8044693
* My model's average accuracy across folds is 0.8119131
